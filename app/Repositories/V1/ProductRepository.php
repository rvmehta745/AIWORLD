...
class ProductRepository extends BaseRepository
{
    ...
    public function store($request)
    {
        $storeData = [
            ...
            'features_and_highlights' => $request->features_and_highlights ?? [],
    ...
    public function update($id, $request)
    {
        ...
        $updateData = [
            ...
            'use_case2' => $request->use_case2 ?? null,
            'use_case3' => $request->use_case3 ?? null,
            'use_cases' => $request->use_cases ?? $data->use_cases ?? [],
            'features_and_highlights' => $request->features_and_highlights ?? $data->features_and_highlights ?? [],
            'additional_info' => $request->additional_info ?? null,
            'twitter' => $request->twitter ?? null,
            'facebook' => $request->facebook ?? null,
            'linkedin' => $request->linkedin ?? null,
