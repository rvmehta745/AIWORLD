...
return new class extends Migration
{
    public function up()
    {
        Schema::create('cms_pages', function (Blueprint $table) {
            ...
            $table->enum('status', ['draft', 'published', 'archived'])->default('draft')->comment('Current publication status of the page');
            ...
            $table->timestamp('deleted_at')->nullable()->comment('Timestamp when the CMS page was soft deleted');
            ...
            $table->foreign('created_by', 'fk_cms_pages_created_by')->references('id')->on('mst_users')->onDelete('set null')->onUpdate('cascade');
            $table->foreign('updated_by', 'fk_cms_pages_updated_by')->references('id')->on('mst_users')->onDelete('set null')->onUpdate('cascade');
            $table->foreign('deleted_by', 'fk_cms_pages_deleted_by')->references('id')->on('mst_users')->onDelete('set null')->onUpdate('cascade');
        });
